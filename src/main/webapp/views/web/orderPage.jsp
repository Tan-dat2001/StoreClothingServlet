            ...
            <section class="module">
                <div class="module-inner">
                    <div class="side-bar">
                        ...
                        <nav class="side-menu">
                            <ul class="nav">
                                <li class="active"><a href="profile.html"><span class="fa fa-user"></span> Hồ sơ</a>
                                </li>
                                <li><a href="order-page.html"><span class="fa fa-credit-card"></span> Đơn mua</a></li>
                                <li><a href="change-password.html"><i class="fa fa-key" aria-hidden="true"></i> Đổi mật khẩu</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="content-panel">
                        <div class="bg-white card mb-4 order-list shadow-sm">
                            <div class="gold-members p-4">
                                ...
                                <div class="media">
                                    <a href="#">
                                        <img class="mr-4" src="images/aothun1.jpg"
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-gray mb-1"><i class="icofont-location-arrow"></i> 730 S
                                        ...
                                        <p class="text-dark">Veg Masala Roll x 1, Veg Burger x 1, Veg Penne Pasta in
                                            Red Sauce x 1
                                        </p>
                                        <hr>
