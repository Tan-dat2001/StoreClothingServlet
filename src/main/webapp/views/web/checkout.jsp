						...
						<form class="needs-validation" novalidate>
							...
							<div class="d-block my-3">
								<div class="custom-control custom-radio">
									<input id="credit" name="paymentMethod" type="radio"
										...
										class="custom-control-label" for="credit">Thẻ tín dụng</label>
								</div>
								<div class="custom-control custom-radio">
							...
							<div class="row">
								<div class="col-md-6 mb-3">
									...
									<small class="text-muted">Vui lòng điền đầy đủ như trên
										thẻ</small>
				...
				<div class="col-sm-6 col-lg-6 mb-3">
					<div class="row">
								...
								<div class="rounded p-2 bg-light">
									<div class="media mb-2 border-bottom">
										<div class="media-body">
											...
											<div class="small text-muted">
												Giá: $80.00 <span class="mx-2">|</span> Số lượng: 1 <span
													class="mx-2">|</span> Tổng: $80.00
											</div>
										</div>
									</div>
									<div class="media mb-2 border-bottom">
										<div class="media-body">
											<a href="detail.html"> Lorem ipsum dolor sit amet</a>
											<div class="small text-muted">
												Giá: $60.00 <span class="mx-2">|</span> Số lượng: 1 <span
													class="mx-2">|</span> Tổng: $60.00
											</div>
										</div>
									</div>
									<div class="media mb-2">
										<div class="media-body">
											<a href="detail.html"> Lorem ipsum dolor sit amet</a>
											<div class="small text-muted">
												Giá: $40.00 <span class="mx-2">|</span> Số lượng: 1 <span
													class="mx-2">|</span> Tổng: $40.00
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-12 d-flex shopping-box">
							<a href="order-detail.html" class="ml-auto btn hvr-hover">Đặt
								hàng</a>
						</div>
					</div>
				</div>
